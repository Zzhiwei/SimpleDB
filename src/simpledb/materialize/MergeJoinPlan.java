...
public class MergeJoinPlan implements Plan {
   ...
   public MergeJoinPlan(Transaction tx, Plan p1, Plan p2, String fldname1, String fldname2) {
      ...
      List<Pair> sortlist1 = Arrays.asList(new Pair(fldname1, true));
      OrderData od1 = new OrderData(sortlist1);
      this.p1 = new SortPlan(tx, p1, od1);
      
      this.fldname2 = fldname2;
      List<Pair> sortlist2 = Arrays.asList(new Pair(fldname2, true));
      OrderData od2 = new OrderData(sortlist2);
      this.p2 = new SortPlan(tx, p2, od2);
